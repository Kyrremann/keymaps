...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_RAISE] = LAYOUT( \
       KC_ESC,  KC_NO,   KC_F1,   KC_F2,   KC_F3,   KC_F4,                             KC_NO,   KC_NO,   KC_UP,   KC_NO,   KC_NO,  KC_NO,   \
       KC_TRNS, KC_NO,   KC_F5,   KC_F6,   KC_F7,   KC_F8,                             KC_NO,   KC_LEFT, KC_DOWN, KC_RGHT, KC_NO,  KC_NO,   \
       KC_TRNS, KC_NO,   KC_F9,   KC_F10,  KC_F11,  KC_F12,                            KC_LCBR, R(KC_8), R(KC_9), KC_RCBR, KC_NO,  KC_TRNS, \
